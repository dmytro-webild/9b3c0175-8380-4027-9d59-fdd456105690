      ...
      <ReactLenis root>
        ...
        <div id="contact" data-section="contact">
          <ContactText
            useInvertedBackground={false}
            background={{ variant: "gradient-bars" }}
            text="SILVERPATH SALES LTD<br>Office: 71-75 Shelton Street, Covent Garden, London<br>Email: info@silverpathsales.co.uk<br>Phone: +44 20 7946 0857<br>Business Hours: Mon-Fri: 09:00 - 17:30, Sat: 10:00 - 14:00"
          />
        </div>
